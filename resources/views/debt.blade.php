        ...
        <div class="row">
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Enter the informations of the new Debt</h5>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/debt/update/'.$debt->id) }}" method="post">
                            ...
                            <div class="form-group">
                                <label>First Name</label>
                                <input value="{{ $debt->firstName }}" name="firstName" type="text" class="form-control"  placeholder="Enter the first name">
                            </div>
                            <div class="form-group">
                                <label>Last Name</label>
                                <input value="{{ $debt->lastName }}" name="lastName" type="text" class="form-control"  placeholder="Enter second name">
                            </div>
                            <div class="form-group">
                                <label>debt</label>
                                <input value="{{ $debt->debt }}" name="debt" type="text" class="form-control"  placeholder="Enter the payment">
                            </div>
                            <div class="form-group">
                                <label>debt</label>
                                <input value="{{ $debt->payment }}" name="payment" type="text" class="form-control"  placeholder="Enter the payment">
                            </div>
